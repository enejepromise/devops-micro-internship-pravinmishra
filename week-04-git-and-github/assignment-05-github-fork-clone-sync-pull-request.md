...
![Screenshort 1](screenshots/git-ass5-shot1.PNG)
---
...
![Screenshort 1](screenshots/git-ass5-shot2.PNG)
...
![Screenshot](screenshots/git-ass5-shot3.PNG)
---
...
![Screenshot](screenshots/git-ass5-shot4.PNG)
...
clea#### Screenshot 6 — Output of `git push -u origin feature-readme-update` showing a successful push

![Screenshot](screenshots/git-ass5-shot6.PNG)

---

#### Screenshot 7 — Your fork on GitHub showing `feature-readme-update` in the branch selector or a "Compare & pull request" banner

![Screenshot](screenshots/git-ass5-shot7.PNG)
...
![Screenshot](screenshots/git-ass5-8.PNG)
...
`https://github.com/pravinmishraaws/devops-micro-internship-interviews/pull/452`
...
`https://lnkd.in/p/e9c6buTA`

---

#### Screenshot — LinkedIn post showing your successfully created Pull Request

![Screenshot](screenshots/git-task5-linkedin-new.PNG)
---
...
`https://github.com/pravinmishraaws/devops-micro-internship-interviews.git
