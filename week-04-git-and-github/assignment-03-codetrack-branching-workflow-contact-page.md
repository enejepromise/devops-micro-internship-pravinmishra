...
![Screenshot 1](screenshots/first-git-status.PNG)
...
![Screenshot 2](screenshots/git-task10-branching.PNG)
...
![Screenshot 3](screenshots/contact-ls.PNG)

---

#### Screenshot 4 — Output of `git commit`

![Screenshot 4](screenshots/gti-task-10-4.PNG)
...
![Screenshot 5](screenshots/git-task10-5.PNG)
---
...
![Screenshot 8](screenshots/git-task10-8-index-output.PNG)
...
![Screenshot 9](<screenshots/git-task10-10-absense of contact.PNG>)
...
![Screenshot 11](screenshots/git-task10-11-merged.PNG)

---

#### Screenshot 12 — Output of `ls` showing `contact.html` after the merge

![Screenshot 12](screenshots/git-task10-12-ls.PNG)
...
![Screenshot 14](screenshots/git-task10-13.PNG)
...
![Screenshot 15](screenshots/git-task10-14delete.PNG)
